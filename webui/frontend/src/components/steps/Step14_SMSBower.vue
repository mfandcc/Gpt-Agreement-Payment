<template>
  <section class="step-fade-in">
    ...
    <p class="step-sub">
      仅用于 Codex OAuth 重登拿 RT 时遇到 <code>add-phone</code> 且页面没有 Skip 的情况。默认关闭；打开后会购买号码、填写手机号、轮询短信验证码并提交。
    </p>
    ...
    <div class="result-block result--warn" style="margin-top:16px">
      <div class="result-head">
        ...
        <span>服务码和国家编号以 SMSBower 后台实时库存为准；如果 OpenAI 页面要求选择国家区号，优先选匹配 country 的号码。</span>
      </div>
    </div>
  </section>
</template>
